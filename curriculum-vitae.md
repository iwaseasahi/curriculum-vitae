...
VPC, Route53, EC2, RDS, S3, ALB, CloudFront, ElastiCache(Redis・memcached), SES, IAM, WAF, ACM, CloudWatch

個人開発で扱ったことのあるサービスは以下です。
...
#### 資格スクエアのプロダクトマネージメント（2019年7月-2021年8月）
...
さらに昨今のセキュリティリスクを考慮して、アプリケーションとインフラの両方で強化しました。
具体的は外部会社にセキュリティ診断を行ってもらい、診断結果を1つ1つ対応しました。
重要なセキュリティ強化は、 2FA の導入とデータの暗号化です。
